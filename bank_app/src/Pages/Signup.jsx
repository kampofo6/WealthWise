...
import deskman from '../assets/signin.svg'
        ...
        <>
          ...
          <div className="SI-form w-1/2 ">
            ...
            <div className='form-box flex flex-col space-y-8 ' >
              ...
              <div>
                <h1 className="SI-h1 text-3xl"> Sign up</h1>
              </div>
              ...
              <form action="" className='space-y-8 ' >
                ...
                <div className='space-y-8 '>
                  ...
                  <div className='inputbox'>
                    ...
                    <input type="text" placeholder='Username' className='w-full leading-8' />
                  </div>
                ...
                <div className='space-y-4 '>
                  <div className='flex  justify-center items-center'>
                    <button className='SI-button1'>Sign up</button>
                  </div>
                  <div className='flex flex-row  justify-center items-center'>


                    <button className='SI-button2'>Sign up with Google</button>
                  </div>
          ...
          <div className="SI-form2 w-1/2 flex flex-col justify-start items-end ">
            {/* 'SU-button rounded-full p-1.5 px-8 h-10  absolute top-0 right-0 m-4' */}
            <div>
